...
filesInvolved = "Difficult2";
prefix = strcat(feMethod+numComponents,"_normalitydev_",filesInvolved);
%% Load data
...
%                 400,400,400; ...
%                 700,700,700];
% classCounts = [100,100,100]; % one row for each data file
...
for fileIdx = 1:numFiles
    for trainVal = 1:ntrainingSize
        for runNum = 1:numIters
            ...
            [~,coeffSel] = maxk(normalityDev,numComponents);
