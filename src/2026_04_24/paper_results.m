...
dir = ["pca_man_train001/","../2026_04_22/man_ht_random_train_001/"];
...
imwrite(getframe(classificationResults).cdata,strcat(dir(1),"pca_wht_",get(classificationResults,'Name'),".png"));
