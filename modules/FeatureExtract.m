classdef FeatureExtract
    ...
    methods(Static)
        ...
        function [featureVector_norm,featureMax,featureMin] = normalizeFeatures2(featureVector)
            featureMax = max(featureVector,[],"all");
            featureMin = min(featureVector,[],"all");

            featureVector_norm = (featureVector-featureMin)./(featureMax-featureMin);
        end %end normalizeFeatures2
